...
class signal:
    ...
    def __init__(self, data, slice, sinal, id) -> None:
        ...
        self.data_sliced = slice  # size limit the dataset by number of rows by use  dtype
    ...
    def to_pandas(self) -> None:
        ...
        self.database = pd.DataFrame(self.real,
                                      self.imag).reset_index().rename(columns={'index': f"{self.sinal}_Real",
